...
const SkillCard = ({ name, icon, color, delay = 0 }: SkillCardProps) => {
  return (
    <ScrollAnimation direction="scale" delay={delay / 1000} duration={0.4}>
      <div className="group bg-deepSpace/50 p-6 rounded-lg text-center hover:bg-cosmicPurple/20 transition-all duration-300 transform hover:-translate-y-2 border border-starWhite/5 hover:border-starWhite/20 backdrop-blur-sm">
